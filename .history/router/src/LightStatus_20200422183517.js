...
const rows = [
  createData(0, 'Boulevard Avroy 1.9',<LED1status></LED1status>, <Rectangle aspectRatio={[1,1]}>
  <div style={{ background: '#008000',  width: '40%', height: '40%' }} />
</Rectangle>),
  createData(2, 'Rue de Londres 2.3', <LED2status></LED2status>,<Rectangle aspectRatio={[1,1]}>
  <div style={{ background: '#FF0000', width: '40%', height: '40%' }} />
</Rectangle>),
  createData(2, 'Rue de Londres 2.5',<LED3status></LED3status>,<Rectangle aspectRatio={[1,1]}>
  <div style={{ background: '#FF0000', width: '40%', height: '40%' }} />
</Rectangle>),
];
