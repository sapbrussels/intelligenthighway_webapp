...
const rows = [
    createData(0, 'Boulevard Avroy 1.9', 'Maintenance',<button>Accept</button>),
    createData(1, 'Rue de Londres 2.1', 'Fix issue',<Link to="/Maintenance"><button>Accept</button></Link>),
];
