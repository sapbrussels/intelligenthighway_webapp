...
const rows = [
    ...
    createData(1, 'Rue de Londres 2.1', 'Fix issue',<Button variant="contained" color="primary">Accept</Button>, <Link to="/Problempage"><Button variant="contained" color="primary">Info</Button></Link>),
];
